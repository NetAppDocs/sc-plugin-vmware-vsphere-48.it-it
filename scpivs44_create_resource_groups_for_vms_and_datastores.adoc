...
+
** Per creare un gruppo di risorse per una macchina virtuale, fare clic su *Menu* > *host e cluster*, quindi fare clic con il pulsante destro del mouse su una macchina virtuale, selezionare NetApp SnapCenter e fare clic su image:scpivs44_image6.png["Errore: Immagine grafica mancante"] *Crea gruppo di risorse*.
